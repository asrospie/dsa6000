# df: the data frame containing the true label (0 or 1 values) column and the score column
# label_colnum: the column number of the label column
# score_colnum: the column number of the score column
# add_on: whether the ROC curve should be add on an existing plot
